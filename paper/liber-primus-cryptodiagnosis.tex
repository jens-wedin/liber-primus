...
% Before submission, replace \documentclass with the HistoCrypt author-kit class
% (Linkoping Electronic Conference Proceedings); the body needs no other change.
% Not compile-tested by the author's tooling (no TeX engine was available); the
% structure is balanced and the specials are escaped, but review on first build.
% ---------------------------------------------------------------------------
...
\item J. Wedin. \emph{Liber Primus cryptanalysis toolkit}. <https://github.com/jens-wedin/liber-primus>, 2026. All statistics, the elimination ledger, and the tests in this paper are reproduced here.
\end{enumerate}
...
\item Reference material: the Uncovering Cicada wiki (<https://uncovering-cicada.fandom.com>); the CicadaSolvers quickstart briefing (<https://www.cicadasolvers.com/quickstart/>); the \emph{Cicada 3301} entry, \emph{Wikipedia}.
\end{enumerate}
